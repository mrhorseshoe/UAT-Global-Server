...
UI_SCENARIO_GRAND_CONCERT = Template("SCENARIO_GRAND_CONCERT", UMAMUSUME_SCENARIO_TEMPLATE_PATH)
...
UI_SCENARIO: dict[ScenarioType, Template] = {
    ...
    ScenarioType.SCENARIO_TYPE_GRAND_CONCERT: UI_SCENARIO_GRAND_CONCERT,
}

# Our Grand Concert: the post-concert "Bonuses Updated!" modal. Cut from the
# body text, which matches nothing else (<=0.568 across the capture set).
UI_CONCERT_BONUSES_UPDATED = Template("CONCERT_BONUSES_UPDATED", UMAMUSUME_UI_TEMPLATE_PATH)
