...
UI_INDEPENDENT_TRAINING_WAIT = Template("INDEPENDENT_TRAINING_WAIT", UMAMUSUME_UI_TEMPLATE_PATH)
# ... and the Training Log a finished run parks on, which has to be dismissed
# before the usual Complete Career flow appears
UI_INDEPENDENT_TRAINING_RESULTS = Template("INDEPENDENT_TRAINING_RESULTS", UMAMUSUME_UI_TEMPLATE_PATH)
...
UI_SCENARIO_TRACKBLAZER = Template("SCENARIO_TRACKBLAZER", UMAMUSUME_SCENARIO_TEMPLATE_PATH)
UI_SCENARIO_GRANDCONCERT = Template("SCENARIO_GRANDCONCERT", UMAMUSUME_SCENARIO_TEMPLATE_PATH)
...
UI_SCENARIO: dict[ScenarioType, Template] = {
    ...
    ScenarioType.SCENARIO_TYPE_TRACKBLAZER: UI_SCENARIO_TRACKBLAZER,
    ScenarioType.SCENARIO_TYPE_GRAND_CONCERT: UI_SCENARIO_GRANDCONCERT,
}
...
UI_FACTOR_REROLL = Template("FACTOR_REROLL", UMAMUSUME_UI_TEMPLATE_PATH)
...
REF_EXTREME_SPIRIT_EXPLOSION = Template("extreme_spirit_explosion", UMAMUSUME_REF_TEMPLATE_PATH)
REF_EXTREME_SPIRIT_EXPLOSION2 = Template("extreme_spirit_explosion2", UMAMUSUME_REF_TEMPLATE_PATH)
REF_EXTREME_SPIRIT_EXPLOSION3 = Template("extreme_spirit_explosion3", UMAMUSUME_REF_TEMPLATE_PATH)
...
REF_INDEPENDENT_TRAINING_TAB = Template("independent_training_tab", UMAMUSUME_REF_TEMPLATE_PATH)
